...
public class Schools extends Fragment implements Api_interface {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser&&setone){
            setone = false;
            new Network_callback(Schools.this,getLat_longs.getLatitude(),getLat_longs.getLongitude(),"school").execute();
        }
    }
